...
@XmlRootElement(name = "BusquedaAlimentoResponse")
public class BusquedaAlimentoResponse {

    @XmlElement(required = true)
    protected List<BusquedaAlimentoResponse.Notificacion> notificacion;
     ...
     * {@link BusquedaAlimentoResponse.Notificacion }
     * 
     * 
     */
    public List<BusquedaAlimentoResponse.Notificacion> getNotificacion() {
        if (notificacion == null) {
            notificacion = new ArrayList<BusquedaAlimentoResponse.Notificacion>();
        }
