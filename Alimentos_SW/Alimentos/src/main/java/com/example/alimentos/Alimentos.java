...
public class Alimentos{
    ...
    private Integer busqueda_precio;
    ...
    public Integer getBusquedaPrecio() {
        return busqueda_precio;
    }

    public void settBusquedaPrecio(Integer busqueda_precio) {
        this.busqueda_precio = busqueda_precio;        
    }
